...
const TopPlayersSideBar: FC<IProfileSideBar> = ({
    ...
    const sendRequestDatabase = async () => {
        try {
            ...
            setIsNicknameChanged(false); // Сбрасываем состояние после подтверждения
        } catch (error) {
                ...
                <div className="user-aside-inner">
                    ...
                    {isVisible === 'profile' && (
                        <div className="user-profile">
                            ...
                            <UserData2 text="Рейтинг" value="1" />
                            ...
                            <div className="user-nickname-container">
                                <div className="user-nickname">
                                    ...
                                    <input type="text" className="user-nickname-input" value={userProfileData.nickname} onChange={(e) => {
                                        setUserProfileData({ ...userProfileData, nickname: e.target.value });
                                        setIsNicknameChanged(true); // Устанавливаем состояние при изменении ника
                                    }}
                                    />
                                </div>
                                {isNicknameChanged && (
                                    <button style={{
                                        ...
                                        cursor: 'pointer',
                                        marginTop: '10px',
                                    }} onClick={sendRequestDatabase}>Подтвердить</button>
                                )}
                            </div>
                        </div>
                    )}
